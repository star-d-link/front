          ...
          <div className="bg-gray-100 min-h-screen p-4">
            ...
            <div className="flex justify-center gap-6 mb-6">
              <div className="flex items-center gap-2">
                <label htmlFor="isOnlineFilter"
                       className="font-medium text-gray-700">온라인
                  여부:</label>
                <select
                    id="isOnlineFilter"
                    value={new URLSearchParams(location.search).get("isOnline")
                        || "all"}
                    onChange={(e) => handleFilterChange("isOnline",
              ...
              <div className="flex items-center gap-2">
                <label htmlFor="isRecruitFilter"
                       className="font-medium text-gray-700">모집 여부:</label>
                <select
                    id="isRecruitFilter"
            ...
            <div
              ...
              {studies.length > 0 ? (
                  ...
                  <div className="col-span-full text-center text-gray-600">스터디
                    목록이 없습니다.</div>
              )}
            </div>
